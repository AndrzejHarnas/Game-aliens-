...
namespace Gierka
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            gameOverText.Text = "Wcisnj Start";
        ...
        private void EndGame()
        {
            if (!playArea.Children.Contains(gameOverText))
            {
                ...
                Wgridzie.Children.Add(gameOverText);
        ...
        private void StartGame()
        {
            ...
            playArea.Children.Clear();
            Wgridzie.Children.Remove(gameOverText);
        ...
        {
            Windows.UI.Xaml.Media.Animation.Storyboard storyboard = new Storyboard() { AutoReverse = true, RepeatBehavior = RepeatBehavior.Forever };
        ...
        private void playArea_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
            if (humanCaptured)
            {
                ...
                Point relativePosition = Wgridzie.TransformToVisual(playArea).TransformPoint(pointerPosition);
